        ...
        <table className="w-full border-collapse text-xs font-mono" data-testid="roster-table">
          <thead>
            <tr className="bg-slate-100 print:bg-gray-200">
              ...
              {isAuthenticated && (
                <th className="text-[10px] font-bold text-slate-500 uppercase tracking-widest p-2 border border-slate-300 w-10 print:hidden text-center" title="Void slot">X</th>
              )}
            </tr>
          </thead>
          <tbody>
